...
const spheres = [
    { id: 1, name: "Forests, Land, & Wildlife", color: "#582626", description: "Dedicated to preserving forests, natural landscapes, and the wildlife that inhabits them, this field plays a crucial role in maintaining biodiversity and preventing habitat loss. It includes land stewardship and wildlife conservation efforts, often integrating traditional ecological knowledge. Careers include Forest and Conservation Program Manager, Wildlife Biologists, and  Habitat Program Manager." },
    { id: 2, name: "Water and Fisheries", color: "#9B1323", description: "This field focuses on protecting freshwater and marine ecosystems while ensuring the sustainability of fish populations. It involves monitoring water quality, restoring aquatic habitats, and managing fisheries to support both ecological balance and Indigenous food systems. Careers in this area include Fisheries Technician, Hatchery Manager, Watershed Restoration Coordinator, and Water Quality Specialist." },
    { id: 3, name: "Government, Law, & Treaty Protection", color: "#C34A4A", description: "This area focuses on creating, enforcing, and advocating for laws and policies that protect Indigenous lands, resources, and treaty rights. It involves legal work, land management, and policy development to ensure environmental justice and sovereignty. Careers include Policy Advisors and Natural Resource Manager." },
    { id: 4, name: "Data and Technology", color: "#B85C38", description: "This field uses digital tools and scientific data to support conservation efforts, monitor environmental changes, and guide land management decisions. Technologies like GIS mapping, remote sensing, and data analysis help track climate impacts and natural resource use. Careers include GIS Specialist, Environmental Data Analyst, and Data Manager." },
    { id: 5, name: "Cultural and Tribal Resources", color: "#7A2F2F", description: "Centered on preserving Indigenous heritage, this field involves protecting sacred sites, passing down traditional ecological knowledge, and ensuring cultural sustainability through environmental stewardship. It often includes community education, land restoration, and advocacy for cultural landscapes. Careers include Cultural Resource Manager and Environmental Outreach and Education Coordinator." },
  ];
    ...
    return (
      ...
      <h3 style={{ fontSize: "3rem", margin: "20px 0"}}>
        ...
        <p style={{ fontSize: "2rem", color: "#311106"}}>
          {hoveredSphere ? hoveredSphere.description : "Rather than the type of career, these spheres of interest describe the kinds of fields careers are situated in. Hover over each circle to learn more about the various spheres of interest for nature conservation careers."}
        </p>
      </div>
      </div>
    );
